    ...
    def __call__(self, predictions, images_root):
        ...
        for img_name, pred_caption in predictions.items():
            ...
            if (clip_score > max_score):
                ...
                max_image_name = image_path
            if (clip_score <= min_score):
                min_score = clip_score
                min_image_name = image_path
        print('min_image_path:', min_image_name, 'score:', min_score)
        print('max_image_path:', max_image_name, 'score:', max_score)
